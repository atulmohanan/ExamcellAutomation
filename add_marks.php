                            ...
                            <div class="card-body">
                                <div class="input-states">
                                   ...
                                   <input type="hidden" name="currnt_date" class="form-control" value="<?php echo $currnt_date;?>">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">SUBJECT 1 MARKS</label>
                                                <div class="col-sm-9">
                                                  <input type="text" name="tfname" class="form-control" placeholder="MARKS" id="event" onkeydown="return alphaOnly(event);" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">SUBJECT 2 MARKS</label>
                                                <div class="col-sm-9">
                                                  <input type="text" name="tfname" class="form-control" placeholder="MARKS" id="event" onkeydown="return alphaOnly(event);" required="">
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">SUBJECT 3 MARKS</label>
                                                <div class="col-sm-9">
                                                  <input type="text" name="tfname" class="form-control" placeholder="MARKS" id="event" onkeydown="return alphaOnly(event);" required="">
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="tfname" class="form-control" placeholder="total" id="event" onkeydown="return alphaOnly(event);" required="">
                                                </div>
                                            </div>
                                        </div>
                                          <div class="form-group">
